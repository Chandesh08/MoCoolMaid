...
{
    public partial class inactiveho : System.Web.UI.Page
    {
        ...
        private void getGridHP()
        {
            ...
            cmd.CommandText = "SELECT * FROM TBLHOUSEOWNER, TBLLOCATION WHERE TBLHOUSEOWNER.LOCATION_ID=TBLLOCATION.LOCATION_ID AND HO_STATUS='Deactive'";
            con.Open();
        ...
        protected void searchjob_TextChanged(object sender, EventArgs e)
        {
            ...
            using (SqlConnection dbconn = new SqlConnection(_conString))
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT * FROM TBLHOUSEOWNER, TBLLOCATION WHERE TBLHOUSEOWNER.LOCATION_ID=TBLLOCATION.LOCATION_ID AND HO_STATUS='Deactive'" + param1;
