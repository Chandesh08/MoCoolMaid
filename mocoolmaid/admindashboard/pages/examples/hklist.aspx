<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hklist.aspx.cs" Inherits="mocoolmaid.admindashboard.pages.examples.hklist" %>
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
                                        <div class="card bg-light">
                                            <div class="card-header text-muted border-bottom-0">
                                                <p class="text-success"><i class="fas fa-user-check"></i> <i><%#Eval("HK_STATUS") %></i></p>
                                            </div>
                                            ...
                                            <div class="card-footer">
                                                <div class="text-right">
                                                    <asp:LinkButton ID="btnselectHK" class="btn btn-sm btn-danger" runat="server" CommandName="id" CommandArgument='<%#Eval("HK_ID") + ";" + Eval("HK_FNAME") + ";" + Eval("HK_LNAME")%>' OnCommand="btnselectHK_Command" Text="Freeze Membership" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
