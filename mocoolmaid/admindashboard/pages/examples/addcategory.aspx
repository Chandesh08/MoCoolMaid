<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addcategory.aspx.cs" Inherits="mocoolmaid.admindashboard.pages.examples.addcategory" %>
                    ...
                    <div class="card card-solid">
                        <div class="card-body pb-0">
                                ...
                                <div class="col-lg-6 col-8">
                                    ...
                                    <div class="small-box bg-primary">
                                        <div class="inner">
                                            ...
                                            <br />
                                            <asp:Button ID="addcat" class="btn btn-sm btn-secondary" runat="server" OnClick="addcat_Click" Text="Add Category" />
                                            <asp:Button ID="updatecat" class="btn btn-sm btn-warning" runat="server" OnClick="updatecat_Click" Text="Update Category" />
                                            <asp:Button ID="delete" class="btn btn-sm btn-danger" runat="server" OnClick="delete_Click" Text="Delete Category" />
                                            <asp:Button ID="cancel" class="btn btn-sm btn-info" runat="server" OnClick="cancel_Click" Text="Cancel" />
                            ...
                            <div class="row d-flex align-items-stretch">
                                ...
                                <asp:ListView ID="catgrid1" runat="server">
                                    <ItemTemplate>
                                        ...
                                        <div class="col-lg-4 col-6">
                                            ...
                                            <div class="small-box bg-secondary">
                                                <div class="inner">
                                                    <br />
                                                    <h5><b>
                                                        <asp:Label ID="catname" runat="server" Text=""><%#Eval("CATEGORY_NAME") %></asp:Label></b></h5>
                                                    <br />

                                                    <asp:LinkButton ID="btnselect" class="btn btn-sm btn-info" runat="server" CommandName="id" CommandArgument='<%#Eval("CATEGORY_ID") + ";" + Eval("CATEGORY_NAME")%>' OnCommand="btnselect_Command" Text="Select Category" />
