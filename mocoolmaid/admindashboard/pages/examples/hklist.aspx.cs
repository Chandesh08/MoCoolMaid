...
{
    public partial class hklist : System.Web.UI.Page
    {
        ...
        protected void btnselectHK_Command(object sender, CommandEventArgs e)
        {
            ...
            if (IsUpdated)
            {
                lblMsg.Text = HKName + " is deactivated successfully!";
            ...
            {
                lblMsg.Text = "Error while deactivating " + HKName + " account";
        ...
        protected void searchjob_TextChanged(object sender, EventArgs e)
        {
            ...
            using (SqlConnection dbconn = new SqlConnection(_conString))
            {
                ...
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT * FROM TBLHOUSEKEEPER, TBLLOCATION WHERE TBLHOUSEKEEPER.LOCATION_ID=TBLLOCATION.LOCATION_ID AND HK_STATUS='Active'" + param1;
