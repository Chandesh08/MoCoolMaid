<%@ Page Title="" Language="C#" MasterPageFile="~/guestmasterpage.Master" AutoEventWireup="true" CodeBehind="candidatelist.aspx.cs" Inherits="mocoolmaid.candidatelist1" %>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>
                            <asp:Label ID="lblcount" runat="server" Text=""></asp:Label></h3>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card1">
                                    ...
                                    <div class="contentBx">
                                        <div class="content">
                                            ...
                                            <asp:HyperLink ID="hkid" runat="server" class="btn btn-default" NavigateUrl='<%#Eval("HK_ID", "~/candidatedetails.aspx?HK_ID={0}") %>' Text="Read More" />
                                        </div>
                                    </div>
                                </div>
                            </div>
