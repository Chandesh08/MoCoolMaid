<%@ Page Title="" Language="C#" MasterPageFile="~/guestmasterpage.Master" AutoEventWireup="true" CodeBehind="holist.aspx.cs" Inherits="mocoolmaid.holist" %>
                        ...
                        <div class="card1">
                            ...
                            <div class="contentBx">
                                <div class="content">
                                    ...
                                    <asp:HyperLink ID="hoid" runat="server" class="btn btn-default"  NavigateUrl='<%#Eval("HO_ID", "~/hodetails.aspx?H0_ID={0}") %>' Text="Read More"/>
                                </div>
                            </div>
                        </div>
                    </div>
