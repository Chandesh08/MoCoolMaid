<%@ Page Title="" Language="C#" MasterPageFile="~/guestmasterpage.Master" AutoEventWireup="true" CodeBehind="candidatedetails.aspx.cs" Inherits="mocoolmaid.candidatedetails" %>
        ...
        <ItemTemplate>
            ...
            <div class="job_listing_area plus_padding">
                <div class="container">
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" class="boxed-btn3" href="hologin.aspx">Open CV</asp:HyperLink>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10" align="left">
                                ...
                                <p><%#Eval("HK_STREET") %> <%#Eval("HK_TOWN") %> <%#Eval("DISTRICT_NAME") %> <span class="dot"></span> <%#Eval("HK_PHONE_NUMBER") %> <span class="dot"></span> <%#Eval("HK_EMAIL") %></p>
                                <hr class="new4">
                                <p class="text-primary"><i class="far fa-id-badge"></i>Professional</p>
