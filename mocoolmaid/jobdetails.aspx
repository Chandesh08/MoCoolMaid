<%@ Page Title="" Language="C#" MasterPageFile="~/guestmasterpage.Master" AutoEventWireup="true" CodeBehind="jobdetails.aspx.cs" Inherits="mocoolmaid.jobdetails" %>
                        ...
                        <div class="col-lg-4">
                            <div class="job_sumary">
                                ...
                                <div class="job_content">
                                    <ul>
                                        <li>Published on: <span><%#Eval("POSTED_DATE", "{0:dd/MM/yyyy}") %></span></li>
                                        <li>Deadline : <span><%#Eval("DEADLINE_DATE", "{0:dd/MM/yyyy}") %></span></li>
