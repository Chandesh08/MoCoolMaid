<%@ Page Title="" Language="C#" MasterPageFile="~/homasterpage.Master" AutoEventWireup="true" CodeBehind="hohome.aspx.cs" Inherits="mocoolmaid.hohome" %>
                    ...
                    <asp:Repeater ID="joblist" runat="server">
                        ...
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            ...
                            <div class="jobs_right">
                                ...
                                <div class="date">
                                    <p style="color: blue;">Deadline Date: <%#Eval("DEADLINE_DATE") %></p>
                                </div>
                                <div class="date">
                                    <p style="color: darkred;">Posted Date: <%#Eval("POSTED_DATE") %></p>
                                </div>
                            </div>
                        </div>
                    </div>
