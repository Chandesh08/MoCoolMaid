...
{
    public partial class hohome : System.Web.UI.Page
    {
        ...
        private void getGridJob()
        {
            ...
            cmd.Connection = con;
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT JOB_ID, JOB_TITLE, JOB_TYPE, DEADLINE_DATE, POSTED_DATE, DISTRICT_NAME FROM TBLJOB, TBLLOCATION WHERE TBLJOB.LOCATION_ID=TBLLOCATION.LOCATION_ID";
            con.Open();
