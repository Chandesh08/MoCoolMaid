<%@ Page Title="" Language="C#" MasterPageFile="~/hkmasterpage.Master" AutoEventWireup="true" CodeBehind="jobapply.aspx.cs" Inherits="mocoolmaid.jobapply" %>
                    ...
                    <asp:Repeater ID="joblist1" runat="server" OnItemDataBound="joblist1_ItemDataBound">
                        ...
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            ...
                            <div class="jobs_right">
                                <div class="apply_now">
                                    <asp:HyperLink ID="id" runat="server"  class="boxed-btn3" NavigateUrl='<%#Eval("JOB_ID", "~/jobdetails1.aspx?JOB_ID={0}") %>' Text="DETAILS"/>
                                    <%--<a href="job_details.html" class="boxed-btn3">Apply Now</a>--%>
                                    <%--<asp:Button ID="apply" class="boxed-btn3" runat="server" Text="Apply Now" />--%>
                                    <asp:LinkButton ID="btnapply" class="boxed-btn3" runat="server" CommandName="id" CommandArgument='<%#Eval("JOB_ID") + ";" + Eval("JOB_TITLE")%>' OnCommand="btnapply_Command" Text="Apply Job" />
                                    <asp:Label ID="deadline" class="boxed-btn2" runat="server" Visible="false" Text="Expired"></asp:Label>
                                </div>
                                <div class="date">
                                    <p style="color: darkred;">Deadline Date: 
                                    <asp:Label ID="lbldate" runat="server"><%#Eval("DEADLINE_DATE", "{0:dd/MM/yyyy}") %></asp:Label></p>
                                    <asp:Label ID="Label1" Visible="false" runat="server"><%#Eval("JOB_STATUS") %></asp:Label>
                                </div>
                                <div class="date">
                                    <p style="color: blue;">Posted Date: <%#Eval("POSTED_DATE", "{0:dd/MM/yyyy}") %></p>
                                </div>
                            </div>
                        </div>
                    </div>
